...
<div className="card-body">
  ...
  <div className="card-actions mt-4 flex justify-between p-4">
    <button onClick={() => onDelete(exam.id)} className="text-red-500 hover:text-red-700 hover:bg-red-100 dark:hover:bg-red-900 p-2 rounded-full transition-all duration-300">
      <Trash2 className="w-4 h-4" />
    </button>
    <button onClick={() => onEdit(exam.id)} className="text-blue-500 hover:text-blue-700 hover:bg-blue-100 dark:hover:bg-blue-900 p-2 rounded-full transition-all duration-300">
      <Pencil className="w-4 h-4" />
